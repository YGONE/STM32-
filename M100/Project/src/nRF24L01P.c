...
const u8 TX_ADDRESS_MB[TX_ADDR_WIDTH]={0xB1,0xB2,0xB3,0xB4,0xB5}; //发送地址
const u8 RX_ADDRESS_MB[RX_ADDR_WIDTH]={0xA1,0xA2,0xA3,0xA4,0xA5}; //接收地址		
/***************************************************************************
...
void Set_RxMode_MB(void)
{
  ...
  //禁止通道0的自动应答    
  NRF24L01_MB_Write_Reg(SPI_WRITE_REG+EN_AA,0x00);    
  //使能通道0的接收地址  	 
